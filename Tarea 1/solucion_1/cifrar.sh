...
for file in "$DOCS_DIR"/*; do
  ...
  # 1️⃣ Generar salt aleatorio (16 bytes)
  SALT=$($OPENSSL rand -hex 16)

  # 2️⃣ Derivar clave con Argon2id (32 bytes)
  ...
  # 3️⃣ Generar IV aleatorio (16 bytes para AES-CBC)
  IV_HEX=$($OPENSSL rand -hex 16)

  # 4️⃣ Cifrar con AES-256-CBC
