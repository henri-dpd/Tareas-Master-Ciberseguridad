...
![Crackme 0 resuelto](<crackme 0 resuelto.png>)
...
![Señal de compresión UPX](crackme1-upx-compress.png)
...
![Desempaquetando con UPX](crackme1-upx-desempaquetar.png)
...
![Código desempaquetado](crackme1-no-ordenado-resultado.png)

Finalmente encontré la contraseña correcta y validé que funcionaba.

![Contraseña correcta Crackme 1](crackme1.png)
...
![IDA no puede analizar correctamente .NET](<metadata crackme2 IDA.png>)
...
![Primer elemento de la contraseña](crackme2DotNet-1.png)

![Lógica completa de generación de contraseña](crackme2DotNet-2.png)
...
![Contraseña correcta Crackme 2](crackme2DotNet-3.png)

### 4. Análisis de Ransomware en ATENEA

#### Ejercicios Completados

![Ejercicios resueltos](<Atenea ejercicios resueltos.png>)
...
![Ejercicio 1 completado](<Atenea ejercicio 1.png>)
...
![Ejercicio 2 completado](<Atenea ejercicio 2.png>)
...
![Ejercicio 3 completado](<Atenea ejercicio 3.png>)
...
![Ejercicio 4 completado](<Atenea ejercicio 4.png>)
...
![Ejercicio 5 completado](<Atenea ejercicio 5.png>)
...
![Análisis de WannaCry](atenea_solucion_wannacry.png)
...
![Interfaz del ransomware](ransomware_click_button.png)

![Extracción de la contraseña](ransomware_get_password.png)

![Creación de contraseña](ransomware_create_pass.png)

![Contraseña del ransomware](contrasenna_ransomware.png)

![Ransomware completado](ransomware_done.png)
...
![IP de Windows XP](xp_ipconfig.png)
...
![Configuración del payload en XP](xp_exploit_set_payload.png)

![Configuración completa del exploit](xp_exploit_set_payload_and_config.png)

Y al ejecutar el comando `exploit`, logro entrar en el XP.

![Explotación exitosa de Windows XP](xp_exploit_done.png)
...
![IP de Windows 2008](win_2008_ipconfig.png)

Luego, identifiqué la vulnerabilidad con nmap:

![Nmap de Windows 2008](win_2008_nmap.png)
...
![Configuración del exploit para 2008](win_2008_config_exploit.png)

Y al ejecutar el comando `exploit`, logro entrar en el Windows 2008.

![Explotación exitosa de Windows 2008](win_2008_exploit_done.png)
...
##### 1. Massscan
![Masscan](mass_scan_poc_1.png)

##### 2. Nmap
![Nmap](mass_scan_poc_2_nmap.png)
...
![Validación del error](test_1_1_validar_error.png)
...
![Análisis en debugger](test_1_2_analisis_debuger.png)
...
![Cálculo de la distancia](test_1_3_calcular_distancia.png)

![Obtención de la dirección de retorno](test_1_3_obtener_direccion_retorno.png)
...
![Distancia calculada](test_1_4_distancia_calculada.png)
...
![Estableciendo instrucciones JMP](test_1_5_1_establecer_instrucciones_jmp.png)

![Estableciendo instrucción en Python](test_1_5_2_establecer_instruccion_py.png)

![Validando instrucción JMP](test_1_5_3_validar_instruccion_jmp.png)
...
![Agregando código de calculadora](test_1_6_1_agregar_codigo_calculadora.png)

![Explotación exitosa - Calculadora ejecutada](test_1_6_2_explotado_calculadora.png)
...
![Validación del error en Test 2](test_2_1_validar_error.png)

#### 5.2 Análisis en Debugger

Analicé el crash en el debugger para entender cómo se comportaba la pila.

![Análisis en debugger Test 2](test_2_2_analisis_debuger.png)

#### 5.3 Cálculo del Offset con Patrón Cíclico

Utilicé el mismo método de patrón cíclico para calcular el offset exacto:

![Cálculo del patrón circular](test_2_3_calcular_patron_circular.png)

![Obtención de la dirección de retorno](test_2_3_obtener_direccion_retorno.png)

![Revisión del EIP](test_2_3_revisar_EIP.png)

#### 5.4 Validación de la distancia calculada

![Distancia calculada](test_2_4_distancia_calculada.png)

#### 5.5 Control del EIP y Explotación

Una vez calculado el offset, establecí el control del EIP y ejecuté mi shellcode:

![Estableciendo EIP](test_2_5_1_establecer_eip.png)

![Estableciendo instrucción en Python](test_2_5_2_establecer_instruccion_py.png)

#### 5.6 Inyección de shellcode

Inyecte la calculadora y valide un exploit exitoso. Siguiente paso poner bind shell.

![Explotación exitosa - Calculadora ejecutada](test_2_6_1_explotado_calculadora.png)

Ahora se crea el código para bing shell desde la kali con `msfvenom` para inyectar el bind shell

![Generar código bind shell](test_2_6_3_generar_payload_shell_bind.png)

Luego ejecutar el programa para que abra la escucha en el puerto 4444, y revisar si la conexión existe

![Conexión en escucha del puerto 4444](test_2_6_2_xp_shell_bid_connection.png)
...
![Exploit XP Bind Shell](test_2_6_4_exploit_kali.png)
